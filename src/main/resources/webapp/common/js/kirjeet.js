...
angular.module('valintalaskenta')
    ...
    .factory('Kirjeet', [ '$modal','Kirjepohjat','Hyvaksymiskirjeet','Latausikkuna','$window','Ilmoitus','IlmoitusTila','KoekutsukirjeetSahkopostita','Koekutsukirjeet',
        function ($modal,Kirjepohjat,Hyvaksymiskirjeet,Latausikkuna,$window,Ilmoitus,IlmoitusTila,KoekutsukirjeetSahkopostita,Koekutsukirjeet) {
                        ...
                        resolve: {
                            oids: function () {
                                return {
                                    ...
                                    tarjoajaOid: kirje.tarjoajaOid,
                                    pohjat: function() {
                                        return Kirjepohjat.get({templateName:kirje.templateName, languageCode: kirje.langcode, tarjoajaOid: kirje.tarjoajaOid, tag: kirje.tag, hakuOid: kirje.hakuOid});
                                    },
