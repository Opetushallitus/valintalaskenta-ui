...
angular
  ...
  .factory('Latausikkuna', [
    '$log',
    '$modal',
    'DokumenttiProsessinTila',
    'IlmoitusTila',
    function ($log, $modal, DokumenttiProsessinTila, IlmoitusTila) {
      return {
        avaaKustomoitu: function (
          id,
          otsikko,
          tila,
          lisatiedot,
          ...
          var cancelTimerWhenClosing = function () {
            DokumenttiProsessinTila.ilmoita({
              id: id,
              poikkeus: 'peruuta prosessi',
            })
          }
        ...
        avaa: function (id, otsikko, lisatiedot, naytaLatausikkuna) {
          this.avaaKustomoitu(
            ...
            IlmoitusTila.INFO,
            lisatiedot,
            '../common/modaalinen/latausikkuna.html',
            {},
            naytaLatausikkuna
          )
        },
