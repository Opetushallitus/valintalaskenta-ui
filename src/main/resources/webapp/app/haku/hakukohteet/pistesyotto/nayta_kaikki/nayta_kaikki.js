...
app.factory('PistesyottoNaytaKaikkiModel', function (
  $q,
  HakukohdeAvaimet,
  ...
  model = new (function () {
    ...
    this.refresh = function (hakukohdeOid, hakuOid) {
      ...
      KoostettuHakemusAdditionalData.get({
        ...
        function (koostetutPistetiedot) {
          model.hakeneet = koostetutPistetiedot.valintapisteet.map(function (
            pistetieto
          ) {
...
angular
  ...
  .controller('PistesyottoNaytaKaikkiController', [
    ...
    function (
      ...
      PistesyottoNaytaKaikkiModel.refreshIfNeeded(
        $scope.hakukohdeOid,
        $routeParams.hakuOid
      )
      ...
      $scope.osallistumislokaalit = [
        {
          value: 'hakukohteetpistesyotto.merkitsematta',
          default_text: 'Merkitsem\u00E4tt\u00E4',
        },
        {
          value: 'hakukohteetpistesyotto.osallistui',
          default_text: 'Osallistui',
        },
        {
          value: 'hakukohteetpistesyotto.eiosallistunut',
          default_text: 'Ei osallistunut',
        },
        {
          value: 'hakukohteetpistesyotto.eivaadita',
          default_text: 'Ei vaadita',
        },
      ]
      $scope.lokaali = function (avain) {
        return _.find($scope.osallistumislokaalit, function (o) {
          return o.value == avain
        }).default_text
      }
      ...
      $scope.osallistumistilat = {
        ...
        EI_OSALLISTUNUT: $scope.lokaali(
          'hakukohteetpistesyotto.eiosallistunut'
        ),
