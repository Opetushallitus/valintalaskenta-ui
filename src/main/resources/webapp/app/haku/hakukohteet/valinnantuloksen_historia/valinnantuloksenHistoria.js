...
angular
  ...
  .factory('valinnantuloksenHistoriaService', [
    '$http',
    '$q',
    function ($http, $q) {
      var fetch = function (valintatapajonoOid, hakemusOid) {
        return $http
          .get(window.url('valinta-tulos-service.muutoshistoria'), {
            params: {
      ...
      return {
        ...
        get: function (valintatapajonoOid, hakemusOid) {
          ...
          if (historia) {
            ...
            var pool = this.pool
            return fetch(valintatapajonoOid, hakemusOid).then(function (
              historia
            ) {
  ...
  .directive('valinnantuloksenHistoria', [
    function () {
      return {
        restrict: 'E',
        scope: {
        ...
        templateUrl:
          'haku/hakukohteet/valinnantuloksen_historia/valinnantuloksenHistoria.html',
      }
    },
  ])
