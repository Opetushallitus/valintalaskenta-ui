angular.module('resources.valvomo', []).factory('ValvomoResource', [
  '$resource',
  function ($resource) {
    'use strict'
    ...
    return $resource(
      plainUrls.url('valintalaskentakoostepalvelu.status', ':resurssi'),
      {},
      {
...
angular.module('valvomo').controller('ValvomoController', [
  ...
  function (
    ...
    var update = function (valittu) {
      ValvomoResource.get({ resurssi: valittu }, function (result) {
...
angular.module('valvomo').config([
  ...
  function ($routeProvider) {
    ...
    $routeProvider
      .when('/valvomo', {
        controller: 'ValvomoController',
        templateUrl: TEMPLATE_URL_BASE + 'haku/hallinta/valvomo.html',
      })
      .when('/valvomo/:selectedTab', {
        controller: 'ValvomoController',
        templateUrl: TEMPLATE_URL_BASE + 'haku/hallinta/valvomo.html',
      })
