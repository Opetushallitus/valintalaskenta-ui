...
var hen = {
  id: 5777299,
  etunimet: 'Jenni',
  syntymaaika: '1989-01-18',
  passinnumero: null,
  hetu: '180189-186C',
  kutsumanimi: 'Jenni',
  oidHenkilo: '1.2.246.562.24.81897278381',
  oppijanumero: null,
  sukunimi: 'Kåla',
  sukupuoli: '2',
  turvakielto: null,
  ...
  duplicate: false,
  created: 1463136655611,
  modified: 1463392189488,
  kasittelijaOid: '1.2.246.562.24.95238236211',
  asiointiKieli: null,
  aidinkieli: null,
  huoltaja: null,
  kayttajatiedot: { id: 5777300, username: 'KOLAJEN-cou-fi355' },
  kielisyys: [],
  kansalaisuus: [],
  yhteystiedotRyhma: [
    {
      ...
      ryhmaAlkuperaTieto: 'alkupera3',
      readOnly: false,
      yhteystiedot: [
        {
          id: 5777306,
          yhteystietoTyyppi: 'YHTEYSTIETO_SAHKOPOSTI',
          yhteystietoArvo: 'jenni.kala@centria.fi',
        },
      ],
    },
    {
...
app.get('/configuration/configuration.js', function (req, res) {
  res.send(
    'SEURANTA_URL_BASE = "http://localhost:3000/seuranta-service/resources";' +
