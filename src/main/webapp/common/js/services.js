angular.module('oph.services', [])
    ...
    .factory('HakukohdeNimiService', ['_', '$rootScope', function (_, $rootScope) {
        "use strict";
        ...
        function getTranslation(rawLangMap) {
            ...
            return translations[lang.toLowerCase()] || translations.fi || translations.sv || translations.en;
        }
        ...
        var service =
        {
            ...
            getTarjoajaNimi:  function(hakukohde) {
                return getTranslation(hakukohde.tarjoajaNimi || hakukohde.tarjoajaNimet)
            },

            getHakukohdeNimi:  function(hakukohde) {
                return getTranslation(hakukohde.hakukohdeNimi || hakukohde.hakukohteenNimet);
            }
        };
        return service;
    }])
