function nayta_kaikkiPage() {
  ...
  var opiskelijatiedotPage = openPage(
    '/valintalaskenta-ui/app/index.html#/haku/h/hakukohde/h0/pistesyotto/naytakaikki',
    function () {
  ...
  var pageFunctions = {
    ...
    nthNameInTable: function (n) {
      return S('.virkailija-table-1 tr:nth-child(' + n + ') td:nth-child(1)')
        .text()
        .trim()
    },
    openPage: function (done) {
      return opiskelijatiedotPage().then(
        wait.until(function () {
