describe('Sijoittelun tulokset välilehti', function () {
  var commonFixturesEiOphOikeuksia = [
    ...
    'APP_KOODISTO',
    'APP_KOODISTO_READ',
    'APP_KOODISTO_READ_1.2.246.562.10.328060821310',
    'APP_HAKUJENHALLINTA',
    'APP_HAKUJENHALLINTA_CRUD',
    'APP_HAKUJENHALLINTA_CRUD_1.2.246.562.10.328060821310',
    'APP_ANOMUSTENHALLINTA',
    'APP_ANOMUSTENHALLINTA_CRUD',
    'APP_ANOMUSTENHALLINTA_CRUD_1.2.246.562.10.328060821310',
    'APP_KOOSTEROOLIENHALLINTA',
    'APP_KOOSTEROOLIENHALLINTA_READ',
    'APP_KOOSTEROOLIENHALLINTA_READ_1.2.246.562.10.328060821310',
    'APP_EPERUSTEET',
    'APP_EPERUSTEET_READ',
    'APP_EPERUSTEET_READ_1.2.246.562.10.328060821310',
    'APP_ORGANISAATIOHALLINTA',
    'APP_ORGANISAATIOHALLINTA_CRUD',
    'APP_ORGANISAATIOHALLINTA_CRUD_1.2.246.562.10.328060821310',
    'APP_OID',
    'APP_OID_READ',
    'APP_OID_READ_1.2.246.562.10.328060821310',
    'APP_TARJONTA',
    'APP_TARJONTA_CRUD',
    'APP_TARJONTA_CRUD_1.2.246.562.10.328060821310',
    'APP_HENKILONHALLINTA',
    'APP_HENKILONHALLINTA_2ASTEENVASTUU',
    'APP_HENKILONHALLINTA_2ASTEENVASTUU_1.2.246.562.10.328060821310',
    'APP_OMATTIEDOT',
    'APP_OMATTIEDOT_READ_UPDATE',
    'APP_OMATTIEDOT_READ_UPDATE_1.2.246.562.10.328060821310',
    'APP_HENKILONHALLINTA',
    'APP_HENKILONHALLINTA_CRUD',
    'APP_HENKILONHALLINTA_CRUD_1.2.246.562.10.328060821310',
    'APP_TIEDONSIIRTO',
    'APP_TIEDONSIIRTO_CRUD',
    'APP_TIEDONSIIRTO_CRUD_1.2.246.562.10.328060821310',
    'APP_KOODISTO',
    'APP_KOODISTO_READ',
    'APP_KOODISTO_READ_1.2.246.562.10.328060821310',
    'APP_ORGANISAATIOHALLINTA',
    'APP_ORGANISAATIOHALLINTA_READ',
    'APP_ORGANISAATIOHALLINTA_READ_1.2.246.562.10.328060821310',
    'APP_VALINTAPERUSTEET',
    'APP_VALINTAPERUSTEET_READ',
    'APP_VALINTAPERUSTEET_READ_1.2.246.562.10.328060821310',
    'APP_HAKEMUS',
    'APP_HAKEMUS_LISATIETORU',
    'APP_HAKEMUS_LISATIETORU_1.2.246.562.10.328060821310',
    'APP_SUORITUSREKISTERI',
    'APP_SUORITUSREKISTERI_READ',
    'APP_SUORITUSREKISTERI_READ_1.2.246.562.10.328060821310',
    'APP_OID',
    'APP_OID_READ',
    'APP_OID_READ_1.2.246.562.10.328060821310',
    'APP_OMATTIEDOT',
    ...
    'APP_VALINTOJENTOTEUTTAMINEN_TULOSTENTUONTI_1.2.246.562.10.328060821310',
    'APP_HENKILONHALLINTA',
    'APP_HENKILONHALLINTA_READ',
    'APP_HENKILONHALLINTA_READ_1.2.246.562.10.328060821310',
    'APP_ASIAKIRJAPALVELU',
    'APP_ASIAKIRJAPALVELU_CREATE_LETTER',
    'APP_ASIAKIRJAPALVELU_CREATE_LETTER_1.2.246.562.10.328060821310',
    'APP_ANOMUSTENHALLINTA',
    'APP_ANOMUSTENHALLINTA_READ',
    'APP_ANOMUSTENHALLINTA_READ_1.2.246.562.10.328060821310',
    'APP_ASIAKIRJAPALVELU',
    'APP_ASIAKIRJAPALVELU_CREATE_TEMPLATE',
    'APP_ASIAKIRJAPALVELU_CREATE_TEMPLATE_1.2.246.562.10.328060821310',
    'APP_RAPORTOINTI',
    'APP_RAPORTOINTI_VALINTAKAYTTAJA',
    'APP_RAPORTOINTI_VALINTAKAYTTAJA_1.2.246.562.10.328060821310',
    'APP_ASIAKIRJAPALVELU',
    'APP_ASIAKIRJAPALVELU_READ',
    'APP_ASIAKIRJAPALVELU_READ_1.2.246.562.10.328060821310',
    'APP_KOOSTEROOLIENHALLINTA',
    'APP_KOOSTEROOLIENHALLINTA_READ',
    'APP_KOOSTEROOLIENHALLINTA_READ_1.2.246.562.10.328060821310',
    'APP_TIEDONSIIRTO',
    'APP_TIEDONSIIRTO_VALINTA',
    'APP_TIEDONSIIRTO_VALINTA_1.2.246.562.10.328060821310',
    'APP_HAKEMUS',
    'APP_HAKEMUS_READ',
    'APP_HAKEMUS_READ_1.2.246.562.10.328060821310',
    'APP_TARJONTA',
    'APP_TARJONTA_READ',
    'APP_TARJONTA_READ_1.2.246.562.10.328060821310',
    'APP_VALINTOJENTOTEUTTAMINEN',
    'APP_VALINTOJENTOTEUTTAMINEN_READ_UPDATE',
    'APP_VALINTOJENTOTEUTTAMINEN_READ_UPDATE_1.2.246.562.10.328060821310',
    'APP_HAKUJENHALLINTA',
    'APP_HAKUJENHALLINTA_READ',
    'APP_HAKUJENHALLINTA_READ_1.2.246.562.10.328060821310',
    'APP_ASIAKIRJAPALVELU',
    'APP_ASIAKIRJAPALVELU_SEND_LETTER_EMAIL',
    'APP_ASIAKIRJAPALVELU_SEND_LETTER_EMAIL_1.2.246.562.10.328060821310',
    'APP_RAPORTOINTI',
    'APP_RAPORTOINTI_READ',
    'APP_RAPORTOINTI_READ_1.2.246.562.10.328060821310',
    'APP_RYHMASAHKOPOSTI',
    'APP_RYHMASAHKOPOSTI_VIEW',
    'APP_RYHMASAHKOPOSTI_VIEW_1.2.246.562.10.328060821310',
    'APP_RYHMASAHKOPOSTI',
    'APP_RYHMASAHKOPOSTI_SEND',
    'APP_RYHMASAHKOPOSTI_SEND_1.2.246.562.10.328060821310',
    'APP_SIJOITTELU',
    'APP_SIJOITTELU_READ_UPDATE',
    'APP_SIJOITTELU_READ_UPDATE_1.2.246.562.10.328060821310',
    'APP_ASIAKIRJAPALVELU',
    'APP_ASIAKIRJAPALVELU_SYSTEM_ATTACHMENT_DOWNLOAD',
    'APP_ASIAKIRJAPALVELU_SYSTEM_ATTACHMENT_DOWNLOAD_1.2.246.562.10.328060821310',
    'APP_YHTEYSTIETOTYYPPIENHALLINTA',
    'APP_YHTEYSTIETOTYYPPIENHALLINTA_READ',
    'APP_YHTEYSTIETOTYYPPIENHALLINTA_READ_1.2.246.562.10.328060821310',
    'APP_HAKULOMAKKEENHALLINTA',
    'APP_HAKULOMAKKEENHALLINTA_CRUD',
    'APP_HAKULOMAKKEENHALLINTA_CRUD_1.2.246.562.10.328060821310',
    'APP_KOODISTO',
    'APP_KOODISTO_READ',
    'APP_KOODISTO_READ_1.2.246.562.10.328060821310',
    'APP_RAPORTOINTI',
    'APP_RAPORTOINTI_OPO',
    'APP_RAPORTOINTI_OPO_1.2.246.562.10.328060821310',
    'APP_ORGANISAATIOHALLINTA',
    'APP_ORGANISAATIOHALLINTA_READ',
    'APP_ORGANISAATIOHALLINTA_READ_1.2.246.562.10.328060821310',
    'APP_TARJONTA',
    ...
    'APP_HAKEMUS',
    'APP_HAKEMUS_OPO',
    'APP_HAKEMUS_OPO_1.2.246.562.10.328060821310',
    'APP_HENKILONHALLINTA',
    'APP_HENKILONHALLINTA_READ',
    'APP_HENKILONHALLINTA_READ_1.2.246.562.10.328060821310',
  ]
  ...
  describe('Opiskelijan valintatulokset, kun valinta on kesken', function () {
    var page = sijoitteluntuloksetPage(
      '1.2.246.562.29.11735171271',
      '1.2.246.562.20.37731636579'
    )
    ...
    describe('avattaessa Iiris Vitsijärven tulokset', function () {
      ...
      it('näkyy, että sijoittelu kesken', function () {
        ...
        assertText(
          sijoitteluntulokset.valintatilanne,
          'personinformationmodal.kesken'
        )
        assertText(
          sijoitteluntulokset.valintatulosTableIndex(1, 1),
          'Aalto-yliopisto, Insinööritieteiden korkeakoulu'
        )
        assertText(
          sijoitteluntulokset.valintatulosTableIndex(1, 2),
          'Energia- ja LVI-tekniikka, diplomi-insinööri KOULUTUS'
        )
        assertText(
          sijoitteluntulokset.valintatulosTableIndex(2, 1),
          'Aalto-yliopisto, Insinööritieteiden korkeakoulu'
        )
        assertText(
          sijoitteluntulokset.valintatulosTableIndex(2, 2),
          'Tietotekniikka, diplomi-insinööri KOULUTUS'
        )
        assertText(
          sijoitteluntulokset.valintatulosTilaIndex(1),
          'Opiskelupaikka vastaanotettu'
        )
        assertText(
          sijoitteluntulokset.valintatulosTilaIndex(2),
          'Et ottanut opiskelupaikkaa vastaan määräaikaan mennessä'
        )
      })
    })
  })
        ...
        listfullFixtures([
          {
            ...
            etunimi: 'Teppo',
            sukunimi: 'Testaaja',
            personOid: '1.2.246.562.11.00000000777',
            asiointikieli: { kieliKoodi: 'fi', kieliTyyppi: 'suomi' },
          },
        ])
      )()
    ...
    /*
        describe('avattaessa Teppo Testaajan tulokset', function () {
            ...
            it('näkyy, että sijoittelu on lopullinen', function() {
                expect(sijoitteluntulokset.koulunNimi().is(':visible')).to.equal(true)
                assertText(sijoitteluntulokset.valintatilanne, "personinformationmodal.lopullinen")
    ...
    describe('vastaanottotilaa muutettaessa', function () {
      before(
        seqDone(
          ...
          select(
            sijoitteluntulokset.vastaanottoDropdown(2),
            'string:VASTAANOTTANUT_SITOVASTI'
          )
        )
      )
  ...
  describe('Sijoittelun tulokset -välilehdellä Kk haussa OPH oikeuksilla', function () {
    ...
    it(
      'Vastaanottotieto alasvetovalikko',
      seqDone(
        wait.forAngular,
        enabled(sijoitteluntulokset.vastaanottotieto),
        function () {
          expect(
            sijoitteluntulokset.vastaanottotieto().children().length
          ).to.equal(7)
    ...
    it(
      'Valintaesitys on hyväksyttävissä',
      seqDone(
        wait.forAngular,
        waitJqueryIs(
          sijoitteluntulokset.hyvaksyValintaesitys,
          '[class~="disabled"]',
          false
        )
      )
    ...
    it(
      'Tulostus buttons are enabled',
      seqDone(
        wait.forAngular,
        waitJqueryIs(sijoitteluntulokset.jalkiohjaus, '.disabled', false),
        waitJqueryIs(
          sijoitteluntulokset.luoHyvaksymiskirjeet,
          '[class~="disabled"]',
          false
        ),
        waitJqueryIs(
          sijoitteluntulokset.createHyvaksymisosoitteet,
          '[class~="disabled"]',
          false
        )
      )
  ...
  describe('Sijoittelun tulokset -välilehti 2. asteen haussa OPH oikeuksilla', function () {
    ...
    it(
      ...
      seqDone(
        wait.forAngular,
        waitJqueryIs(
          sijoitteluntulokset.jalkiohjaus,
          '[class~="disabled"]',
          false
        ),
        waitJqueryIs(
    ...
    it(
      'Ehdollinen valinta is not visible',
      seqDone(
        wait.forAngular,
  ...
  describe('Sijoittelun tulokset -välilehti 2. asteen haussa ilman OPH oikeuksia, kun valintaesitys ei vielä hyväksyttävissä', function () {
    ...
    it(
      'Valintaesitys ei vielä hyväksyttävissä',
      seqDone(
        wait.forAngular,
    ...
    it(
      'Jälkiohjaus nappi is not visible',
      seqDone(
        wait.forAngular,
  ...
  describe('Sijoittelun tulokset -välilehti 2. asteen haussa ilman OPH oikeuksia, kun valintaesitys hyväksyttävissä', function () {
    ...
    it(
      'Vastaanottotieto alasvetovalikko',
      seqDone(enabled(sijoitteluntulokset.vastaanottotieto), function () {
        /*                assertText(sijoitteluntulokset.vastaanottotietoOption(0), "Kesken");
                assertText(sijoitteluntulokset.vastaanottotietoOption(1), "Vastaanottanut");
                assertText(sijoitteluntulokset.vastaanottotietoOption(2), "Ei vastaanotettu määräaikana");
                assertText(sijoitteluntulokset.vastaanottotietoOption(3), "Perunut");*/
  ...
  describe('Hakemuksen tila sijoittelun tulokset -välilehdellä PERUUNTUNUT jos käyttäjällä PERUUNTUNEIDEN_HYVAKSYNTA oikeus', function () {
    ...
    beforeEach(function (done) {
      ...
      addTestHook(parametritFixtures)()
      addTestHook(koodistoFixtures)()
      addTestHook(sijoitteluAjoPeruuntunutFixtures)()
      addTestHook(ohjausparametritFixtures())()
      addTestHook(dokumenttipalveluFixtures)()
      addTestHook(organisaatioFixtures)()
      addTestHook(httpFixtures().hakukohteenAvaimet)()
    ...
    var jonoOid = '14962115489146641379218558169432'
    var hakemusOid = '1.2.246.562.11.00007967463'
    //hyvaksyPeruuntunut-14962115489146641379218558169432-122465621100007967463
    //hyvaksyPeruuntunut-14962115489146641379218558169432-122465621100007967463
    it(
      'voidaan hyväksyä',
      seqDone(
        wait.forAngular,
        //wait.forMilliseconds(1000*60),
        ...
        checked(
          sijoitteluntulokset.hyvaksyPeruuntunut(jonoOid, hakemusOid)
        ) /*,
            expectPost(
    ...
    hakemusOid = '1.2.246.562.11.00000000666'
    it(
      'hyväksytyltä voidaan poistaa hyväksyntä',
      seqDone(
        wait.forAngular,
        visible(sijoitteluntulokset.hyvaksyPeruuntunut(jonoOid, hakemusOid)),
        checked(sijoitteluntulokset.hyvaksyPeruuntunut(jonoOid, hakemusOid)),
    ...
    hakemusOid = '1.2.246.562.11.00000000666'
    it(
      'estä Hyväksy peruuntunut muuttaminen jos julkaistavissa',
      seqDone(
        wait.forAngular,
        visible(sijoitteluntulokset.hyvaksyPeruuntunut(jonoOid, hakemusOid)),
        checked(sijoitteluntulokset.hyvaksyPeruuntunut(jonoOid, hakemusOid)),
        click(sijoitteluntulokset.julkaistavissa(3)),
  ...
  describe('Hakemuksen tila sijoittelun tulokset -välilehdellä PERUUNTUNUT ilman PERUUNTUNEIDEN_HYVAKSYNTA oikeutta', function () {
    ...
    var jonoOid = '14962115489146641379218558169432'
    it(
      'Hyväksy checkbox ei näy ja se on disabled tilassa',
      seqDone(
        wait.forAngular,
        ...
        disabled(
          sijoitteluntulokset.hyvaksyPeruuntunut(
            jonoOid,
            '1.2.246.562.11.00001941430'
          )
        )
      )
    )
  ...
  describe('Hyväksymiskirjeen lähettämisen tieto, kun kirjettä ei ole lähetetty aiemmin', function () {
    ...
    it(
      'Hyväksymiskirje lähetetty on täpättävissä ja näkyvissä',
      seqDone(
        wait.forAngular,
        click(sijoitteluntulokset.hyvaksymiskirjeLahetettyCheckbox(1)),
        function () {
          assertText(
            sijoitteluntulokset.hyvaksymiskirjeLahetettyTextAtIndex(1),
            'Hyväksymiskirje lähetetty:'
          )
        }
      )
    )
  ...
  describe('Hyväksymiskirjeen lähettämisen tieto, kun kirje on lähetetty aiemmin', function () {
    ...
    it(
      'Hyväksymiskirje lähetetty on täpättävissä ja näkyvissä ja lähetyspäivämäärä on näkyvillä',
      seqDone(
        wait.forAngular,
        click(sijoitteluntulokset.hyvaksymiskirjeLahetettyCheckbox(1)),
        function () {
          ...
          expect(
            sijoitteluntulokset.hyvaksymiskirjeLahetettyPvm(1)().text().trim()
              .text
          ).to.not.equal(0)
        }
      )
