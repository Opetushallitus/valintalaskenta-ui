describe('Henkilötiedot näkymä', function () {
  ...
  beforeEach(function (done) {
    ...
    addTestHook(
      hakemusByOidFixtures({
        hakemusOid: HAKEMUS1,
        etunimi: 'Erkki',
        sukunimi: 'Hakija1',
        hakuOid: HAKU1,
        hakutoiveet: [
          '1.2.246.562.20.24986103166',
          '1.2.246.562.20.61608097517',
          '1.2.246.562.20.76237731328',
          '1.2.246.562.20.270241078010',
          '1.2.246.562.20.34911042264',
        ],
      })
    )()
    addTestHook(
      valintalaskentaValintakokeetHakemukselleFixtures({
        hakemusOid: HAKEMUS1,
        etunimi: 'Erkki',
        sukunimi: 'Hakija1',
        hakuOid: HAKU1,
    ...
    addTestHook(
      valintalaskentaHakemukselleFixtures({
        hakemusOid: HAKEMUS1,
        etunimi: 'Erkki',
        sukunimi: 'Hakija1',
        hakuOid: HAKU1,
  ...
  describe('Näyttää', function () {
    it(
      'henkilön valintalaskennan tulokset',
