describe('Perustiedot', function () {
  ...
  describe('Perustiedot-taulukko', function () {
    ...
    it(
      'sisältää kaikki valintatapajonot',
      seqDone(wait.forAngular, function () {
        assertText(
          perustiedotSelectors.valintatapajonoAtIndex(1),
          'Valintaryhmä I'
        )
      })
    )
    ...
    it(
      'ainoastaan hyväksytyt hakemukset lasketaan mukaan vastaanottaneisiin',
      seqDone(wait.forAngular, function () {
