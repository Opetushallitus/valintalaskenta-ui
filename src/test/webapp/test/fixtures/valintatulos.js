function valintatulosFixture() {
    ...
    httpBackend.when('GET', /.*valintalaskentakoostepalvelu\/resources\/proxy\/valintatulos\/haku\/1\.2\.246\.562\.29\.11735171271\/hakemusOid\/1\.2\.246\.562\.11\.00003935855/).respond(valintatulos);
}
