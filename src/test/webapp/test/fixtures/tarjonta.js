function tarjontaFixtures() {
    ...
    var lisahakuHakukohde = {
        "accessRights": {},
        "result": {
            "modified": 1439203418159,
            ...
            "hakukohteenNimet": {
                "kieli_sv": "",
                "kieli_en": "",
                "kieli_fi": "Arkeologia, filosofian maisteri"
            },
            "tarjoajaNimet": {
                "fi": "Turun yliopisto, Humanistinen tiedekunta",
                "sv": "Åbo universitet, Humanistiska fakulteten",
                "en": "University of Turku, Faculty of Humanities"
            },
            "koulutusmoduuliToteutusTarjoajatiedot": {"1.2.246.562.17.61368418184": {"tarjoajaOids": ["1.2.246.562.10.520877937010"]}},
            "tarjoajaOids": ["1.2.246.562.10.520877937010"],
            "hakuOid": "1.2.246.562.29.97467487498",
            "hakuaikaId": "2389345",
            "hakukelpoisuusvaatimusUris": ["pohjakoulutusvaatimuskorkeakoulut_107"],
            "hakukohdeKoulutusOids": ["1.2.246.562.17.61368418184"],
            "alinHyvaksyttavaKeskiarvo": 0.0,
            "alinValintaPistemaara": 0,
            "ylinValintapistemaara": 0,
            "aloituspaikatLkm": 1,
            ...
            "liitteidenToimitusOsoite": {
                "version": 0,
                "osoiterivi1": "Opiskelija- ja hakijapalvelut, Yliopistonmäki",
                "postinumero": "posti_20014",
                "postinumeroArvo": "20014",
    ...
    httpBackend.when('GET', /.*\/tarjonta-service\/rest\/v1\/hakukohde\/LISAHAKUKOHDE/).respond(lisahakuHakukohde)
    ...
    var lisahakuHaku = {
        ...
        "result": {
            "modified": 1439391009542,
            "modifiedBy": "1.2.246.562.24.72453542949",
            "oid": "1.2.246.562.29.97467487498",
            "hakukausiUri": "kausi_k#1",
            "hakukausiVuosi": 2015,
            "hakutapaUri": "hakutapa_01#1",
            "hakutyyppiUri": "hakutyyppi_03#1",
            "kohdejoukkoUri": "haunkohdejoukko_12#1",
            "koulutuksenAlkamisVuosi": 2015,
            "koulutuksenAlkamiskausiUri": "kausi_s#1",
            "tila": "JULKAISTU",
            "ylioppilastutkintoAntaaHakukelpoisuuden": false,
            "hakukohdeOidsYlioppilastutkintoAntaaHakukelpoisuuden": ["1.2.246.562.20.31450195396", "1.2.246.562.20.327526503110"],
            "sijoittelu": false,
            "jarjestelmanHakulomake": true,
            "hakuaikas": [{
                "hakuaikaId": "2389345",
                "alkuPvm": 1436274765572,
                "loppuPvm": 1439289960000,
                "nimet": {"kieli_sv": "", "kieli_en": "", "kieli_fi": ""}
            }],
            "hakukohdeOids": ["1.2.246.562.20.31450195396", "1.2.246.562.20.327526503110"],
            "nimi": {
                "kieli_sv": "",
                "kieli_en": "",
                "kieli_fi": "Valintarekisteri - Lisähaku"
            },
            "maxHakukohdes": 2,
            "organisaatioOids": ["1.2.246.562.10.00000000001"],
            "tarjoajaOids": ["1.2.246.562.10.00000000001"],
            "usePriority": false,
            "parentHakuOid": "1.2.246.562.29.532912449110",
            "sisaltyvatHaut": [],
            "organisaatioryhmat": [],
            "koulutusmoduuliTyyppi": "TUTKINTO"
        },
