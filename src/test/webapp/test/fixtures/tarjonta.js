function tarjontaFixtures() {
    ...
    httpBackend.when('GET', /.*\/tarjonta-service\/rest\/v1\/hakukohde\/(1\.2\.246\.562\.20\.37731636579|1\.2\.246\.562\.11\.00000000220|1\.2\.246\.562\.20\.66977493197)/).respond(hakukohde)
