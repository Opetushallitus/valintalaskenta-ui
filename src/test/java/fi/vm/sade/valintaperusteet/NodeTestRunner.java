...
/** -Dkooste_server=http://localhost:8090 -Dpublic_server=https://itest-virkailija.oph.ware.fi */
public class NodeTestRunner {

  public static void startNodeJs() throws Exception {
    final CommandLine cmdLine =
        new CommandLine("node")
            .addArgument("--harmony")
            .addArgument("ui/valintalaskenta-ui/server/server.js");
    new DefaultExecutor()
        .execute(
            cmdLine,
            ImmutableMap.of(
                ...
                "kooste_server", propertyOrEmptyString("kooste_server")),
