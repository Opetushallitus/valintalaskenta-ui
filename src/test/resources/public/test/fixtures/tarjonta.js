function tarjontaFixtures() {
  ...
  var haku = {
    result: {
      ...
      nimi: {
        kieli_sv: '',
        kieli_en: '',
        kieli_fi: 'valintatulokset-sijoitteluun haku',
      },
      maxHakukohdes: 1,
  ...
  var hakukohde = {
    result: {
      ...
      version: 1,
      hakukohteenNimet: {
        kieli_fi: 'Energia- ja LVI-tekniikka, diplomi-insinööri KOULUTUS',
      },
      tarjoajaNimet: {
  ...
  httpBackend
    .when(
      'GET',
      /.*\/valintalaskentakoostepalvelu\/resources\/tarjonta-service\/rest\/v1\/haku\/1\.2\.246\.562\.29\.11735171271$/
    )
    .respond(haku)
  httpBackend
    .when(
      'GET',
      /.*\/valintalaskentakoostepalvelu\/resources\/tarjonta-service\/rest\/v1\/haku\/HAKU1/
    )
    .respond(haku)
  httpBackend
    .when(
      'GET',
      /.*\/valintalaskentakoostepalvelu\/resources\/tarjonta-service\/rest\/v1\/hakukohde\/(1\.2\.246\.562\.20\.25463238029|1\.2\.246\.562\.20\.37731636579|1\.2\.246\.562\.11\.00000000220|1\.2\.246\.562\.20\.66977493197)/
    )
    .respond(hakukohde)
  httpBackend
    .when(
      'GET',
      /.*\/valintalaskentakoostepalvelu\/resources\/tarjonta-service\/rest\/v1\/haku\/1\.2\.246\.562\.29\.90697286251/
    )
    .respond({
      status: 'OK',
      result: {
        organisaatioryhmat: [],
        sisaltyvatHaut: ['1.2.246.562.29.50116113601'],
        usePriority: true,
        tarjoajaOids: ['1.2.246.562.10.00000000001'],
        organisaatioOids: ['1.2.246.562.10.00000000001'],
        maxHakukohdes: 5,
        nimi: {
          ...
          kieli_en:
            'Joint application to upper secondary education, spring 2015',
  ...
  httpBackend
    .when(
      'GET',
      /.*\/valintalaskentakoostepalvelu\/resources\/tarjonta-service\/rest\/v1\/haku\/1\.2\.246\.562\.29\.95390561488/
    )
    .respond({
      status: 'OK',
      result: {
        koulutusmoduuliTyyppi: 'TUTKINTO',
        sisaltyvatHaut: ['1.2.246.562.29.88144464125'],
        usePriority: true,
        tarjoajaOids: ['1.2.246.562.10.00000000001'],
        organisaatioOids: ['1.2.246.562.10.00000000001'],
        maxHakukohdes: 6,
  ...
  httpBackend
    .when(
      'GET',
      /.*\/valintalaskentakoostepalvelu\/resources\/tarjonta-service\/rest\/v1\/hakukohde\/HAKUKOHDEOID/
    )
    .respond(hakukohde)
  httpBackend
    .when(
      'GET',
      /.*\/valintalaskentakoostepalvelu\/resources\/tarjonta-service\/rest\/v1\/hakukohde\/HAKUKOHDE1/
    )
    .respond(hakukohde)
  httpBackend
    .when(
      'GET',
      /.*\/valintalaskentakoostepalvelu\/resources\/tarjonta-service\/rest\/v1\/hakukohde\/HAKUKOHDE_OID_NO_VIITE_YES_SYOTTO/
    )
    .respond(hakukohde)
  httpBackend
    .when(
      'GET',
      /.*\/valintalaskentakoostepalvelu\/resources\/tarjonta-service\/rest\/v1\/hakukohde\/1\.2\.246\.562\.20\.18097797874/
    )
    .respond({
      status: 'OK',
      result: {
        ...
        hakukohdeKoulutusOids: ['1.2.246.562.17.66475582756'],
        hakukelpoisuusvaatimusUris: ['hakukelpoisuusvaatimusta_5#1'],
        hakuaikaId: '703390',
        hakuOid: '1.2.246.562.29.90697286251',
        tarjoajaOids: ['1.2.246.562.10.10464399921'],
        koulutusmoduuliToteutusTarjoajatiedot: {
  ...
  httpBackend
    .when(
      'GET',
      /.*\/valintalaskentakoostepalvelu\/resources\/tarjonta-service\/rest\/v1\/hakukohde\/1\.2\.246\.562\.20\.44161747595/
    )
    .respond({
      status: 'OK',
      result: {
        ...
        painotettavatOppiaineet: [],
        soraKuvausKielet: [],
        valintaPerusteKuvausKielet: ['kieli_sv', 'kieli_fi'],
        opetusKielet: ['kieli_fi', 'kieli_sv'],
        kaksoisTutkinto: false,
        ...
        alinValintaPistemaara: 0,
        alinHyvaksyttavaKeskiarvo: 0.0,
        hakukohdeKoulutusOids: ['1.2.246.562.17.85833549059'],
        hakukelpoisuusvaatimusUris: ['pohjakoulutusvaatimuskorkeakoulut_123'],
        hakuaikaId: '220207',
        ...
        hakukohteenNimet: {
          kieli_fi:
            'Rakennettu ymp\u00e4rist\u00f6, tekniikan kandidaatti ja diplomi-insin\u00f6\u00f6ri, DIA-yhteisvalinta',
          kieli_en: '',
          kieli_sv:
            'Den byggda milj\u00f6n, teknologie kandidat och diplomingenj\u00f6r, DIA gemensamma antagningen',
        },
        version: 31,
  ...
  httpBackend
    .when(
      'GET',
      /.*\/valintalaskentakoostepalvelu\/resources\/tarjonta-service\/rest\/v1\/haku\/find\?addHakukohdes=false/
    )
    .respond({
      result: [
        {
          ...
          nimi: {
            kieli_sv: '',
            kieli_en: '',
            kieli_fi: 'MJK-instituutti, taloushallinnon ammattitutkinto',
          },
          maxHakukohdes: 0,
    ...
    tulokset: [
      ...
      },
      {
        ...
        hakukohdeNimi: {
            ...
            'Hotelli-, ravintola- ja catering-alan perustutkinto, yes syöttö, yo',
          sv:
            'Grundexamen inom hotell-, restaurang- och cateringbranschen, yes syöttö, st',
          en:
            'Hotelli-, ravintola- ja catering-alan perustutkinto, yes syöttö, yo',
        },
        hakukohdeTila: 'JULKAISTU',
  ...
  httpBackend
    .when(
      'GET',
      /.*\/valintalaskentakoostepalvelu\/resources\/tarjonta-service\/rest\/v1\/haku\/HAKUOID\/hakukohdeTulos/
    )
    .respond(hakukohdeTulos)
  httpBackend
    .when(
      'GET',
      /.*\/valintalaskentakoostepalvelu\/resources\/tarjonta-service\/rest\/v1\/haku\/1\.2\.246\.562\.29\.11735171271\/hakukohdeTulos/
    )
    .respond(hakukohdeTulos)

  httpBackend.when('GET', /.*\/kouta-internal\/haku\/search/).respond([])
  httpBackend
    .when('GET', /.*\/kouta-internal\/hakukohde\/search/)
    .respond(404, {})
